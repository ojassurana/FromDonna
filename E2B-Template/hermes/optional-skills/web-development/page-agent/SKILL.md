...
- User wants **the agent itself to drive a browser** → use the agent's built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
