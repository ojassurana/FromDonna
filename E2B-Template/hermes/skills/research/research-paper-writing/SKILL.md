...
This skill is designed for the agent. It uses agent tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other agent skills for specific phases:
