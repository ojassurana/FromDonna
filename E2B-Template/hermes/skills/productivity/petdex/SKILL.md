---
name: petdex
description: Install and select animated petdex mascots for the agent.
version: 1.0.0
author: Donna
license: MIT
...
the agent CLI, TUI, and desktop app. This skill drives the `hermes pets` CLI
...
- Pillow (a core agent dependency) for sprite decoding — already installed.
...
- The petdex npm CLI installs to `~/.codex/pets`; the agent uses its own
