...
| [gateway/compaction.md](./gateway/compaction.md) | **Context compression** — mute TG packing, post-turn silent compact, knobs |
...
| [hermes/identity-and-memory.md](./hermes/identity-and-memory.md) | **SOUL / MEMORY / USER** — prompt order, freeze policy, template flags (`memory_enabled: false`) |
...
| [tooling/mcp-proxy-protocol.md](./tooling/mcp-proxy-protocol.md) | **Protocol: adding another product MCP** — shared door + capability Bearer (Composio is the reference) |
